...
<template>
    ...
    <BreezeAuthenticatedLayout>
        <template #header class="flex">
            ...
            <Link
                :href="route('roles.create')" v-if="$page.props.auth.access.indexOf('create roles') != -1"
                            ...
                            >
                                ...
                                <tbody>
                                    ...
                                    >
                                        ...
                                        >
                                            <Link v-if="$page.props.auth.access.indexOf('view roles') != -1"
                                                :href="
                                                    route(
                                                        'roles.show',
                                                        role.id
                                                ...
                                                >View</Link
                                            >
                                            <Link v-if="$page.props.auth.access.indexOf('update roles') != -1"
                                                :href="
                                                    route(
                                                        'roles.edit',
                                                        role.id
                                                ...
                                                >Edit</Link
                                            >
                                            <BreezeButton v-if="$page.props.auth.access.indexOf('delete roles') != -1"
