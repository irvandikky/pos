...
<template>
    ...
    <BreezeAuthenticatedLayout>
        <template #header class="flex">
            ...
            <Link
                :href="route('categories.create')" v-if="$page.props.auth.access.indexOf('create categories') != -1"
                            ...
                            >
                                ...
                                <tbody>
                                    ...
                                    >
                                        ...
                                        >
                                            <Link v-if="$page.props.auth.access.indexOf('view categories') != -1"
                                                :href="
                                                    route(
                                                        'categories.show',
                                                        category.id
                                                ...
                                                >View</Link
                                            >
                                            <Link v-if="$page.props.auth.access.indexOf('update categories') != -1"
                                                :href="
                                                    route(
                                                        'categories.edit',
                                                        category.id
                                                ...
                                                >Edit</Link
                                            >
                                            <BreezeButton v-if="$page.props.auth.access.indexOf('delete categories') != -1"
